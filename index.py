...
HOTELS_CSV = (
    "A2501,HA0H2,HA1C8,HA1F2,H0768,HC1X6,HB858,HB727,H7202,H6665,58778,H9596,H5468,H9382,H9360,"
...
@app.get("/api/possible-labels")
def get_possible_labels():
    return POSSIBLE_LABELS

@app.get("/api/hotels")
def get_hotels_txt():
    return PlainTextResponse(HOTELS_CSV)
